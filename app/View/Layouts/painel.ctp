    ...
    <head>
        ...
        <script>
          tinymce.init({ 
            ...
            menubar: false,       
            height: 250,
            toolbar: 'undo redo | bold italic underline | removeformat | alignleft| numlist bullist | link'
            });
        </script>
    </head>
    <body>
      ...
      <div class="container">
        ...
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
            ...
            <?php
                echo $this->Html->link('Painel Lenergy', array('controller'=>'pages', 'action' => 'index'), array('class' => 'navbar-brand'));
            ?>         
        </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="list-group lis">
                        ...
                        <?php echo $this->Html->link('Serviços', array('controller' => 'servicos', 'action' => 'index', 'admin' => true), array('class' => 'list-group-item','alt' => '', 'title' => '')); ?>

                        <?php echo $this->Html->link('Clientes e projetos', array('controller' => 'projetos', 'action' => 'index', 'admin' => true), array('class' => 'list-group-item','alt' => '', 'title' => '')); ?>
